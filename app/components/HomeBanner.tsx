...
const HomeBanner = () => {
  return (
    <div className="relative bg-gradient-to-r from-sky-400 to-sky-800 mb-8">
      <div className="mx-auto px-8 py-12 flex flex-col gap-2 md:flex-row items-center justify-evenly">
        <div className="mb-8 md:mb-0 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">Summer Sale</h1>
          <h1 className="text-lg md:text-xl text-white mb-2">Enjoy discounts on selected items</h1>
